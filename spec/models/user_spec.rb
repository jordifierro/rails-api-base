  ...
  describe "validates" do
    ...
    it "password length" do
      expect {
        create(:user,
               password: "1234",
               password_confirmation: "1234")}.to raise_error(
                                                    ActiveRecord::RecordInvalid)

      expect {
        create(:user,
               password: "x" * 80,
               password_confirmation: "x" * 80)}.to raise_error(
                                                    ActiveRecord::RecordInvalid)
      expect( create(:user, password: "12345678",
    ...
    it "password confirmation" do
      expect {
        create(:user,
               ...
               password_confirmation: "another_password") }.to raise_error(
                                                    ActiveRecord::RecordInvalid)
